<?php
	...
	$edit_url = admin_url( 'admin.php?page=grid-accordion-lite&id=' . $accordion_id . '&action=edit' );
	$preview_url = admin_url( 'admin.php?page=grid-accordion-lite&id=' . $accordion_id . '&action=preview' ) . '&lad_nonce=' . $lad_nonce;
	$delete_url = admin_url( 'admin.php?page=grid-accordion-lite&id=' . $accordion_id . '&action=delete' ) . '&da_nonce=' . $delete_nonce;
	$duplicate_url = admin_url( 'admin.php?page=grid-accordion-lite&id=' . $accordion_id . '&action=duplicate' ) . '&dua_nonce=' . $duplicate_nonce;
?>
