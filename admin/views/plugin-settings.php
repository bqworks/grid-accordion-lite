<div class="wrap grid-accordion-admin plugin-settings">
	<h2><?php _e( 'Plugin Settings', 'grid-accordion-lite' ); ?></h2>
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a class="button-secondary clear-all-cache" data-nonce="<?php echo wp_create_nonce( 'clear-all-cache' ); ?>"><?php _e( 'Clear all cache now', 'grid-accordion-lite' ); ?></a>
