    	...
    	<div class="metabox-holder has-right-sidebar">
            ...
            <div class="inner-sidebar meta-box-sortables ui-sortable">
                ...
                <div class="sidebar-settings">
                    <?php 
                        $setting_groups = BQW_Grid_Accordion_Lite_Settings::getSettingGroups();
                        $panels_state = BQW_Grid_Accordion_Lite_Settings::getPanelsState();
                                        ...
                                        <tbody>
                                            <?php
                                                foreach ( $group['list'] as $setting_name ) {
                                                    $setting = BQW_Grid_Accordion_Lite_Settings::getSettings( $setting_name );
                                            ?>
                                                    <tr>
                                                        <td>
